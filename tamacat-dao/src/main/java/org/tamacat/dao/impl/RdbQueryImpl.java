...
public class RdbQueryImpl<T extends ORMappingSupport> implements RdbQuery<ORMappingSupport> {
    ...
    public RdbQuery<ORMappingSupport> andSearch(RdbSearch search, RdbSort sort) {
        return addSearch("and", search, sort);
    }

    public RdbQuery<ORMappingSupport> orSearch(RdbSearch search, RdbSort sort) {
    ...
    public RdbQuery<ORMappingSupport> andSort(RdbSort sort) {
    ...
    private RdbQuery<ORMappingSupport> addSearch(String condition, RdbSearch search, RdbSort sort) {
