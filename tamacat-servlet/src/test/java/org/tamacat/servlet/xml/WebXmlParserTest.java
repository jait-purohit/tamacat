...
public class WebXmlParserTest {
	...
	public void testParse() {
		...
		assertEquals("org.tamacat.servlet.test.SampleServlet", servletDefine1.getServletClass());
		...
		assertEquals("org.tamacat.servlet.test.SampleServlet", servletDefine2.getServletClass());
